...
public class CandlestickFactoryTest {
	...
	@Test
	public void paraNegociacoesDeTresDiasDintintosGerarTresCandles(){
		Calendar hoje = Calendar.getInstance();
		...
		List<Candlestick> candles = fabrica.constroiCandle(negociacoes);
		...
		Assert.assertEquals(48.8, candles.get(0).getAbertura(), 0.00001);
		Assert.assertEquals(49.3, candles.get(0).getFechamento(), 0.00001);
		Assert.assertEquals(51.8, candles.get(0).getAbertura(), 0.00001);
